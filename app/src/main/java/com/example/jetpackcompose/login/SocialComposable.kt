...
import com.example.jetpackcompose.login.ui.theme.LightBlueWhite
...
fun SocialMedia(
    ...
    onClick:()->Unit,) {
     Row (modifier = modifier
         ...
         Image(painter = painterResource(id = icon),null,modifier = Modifier.size(16.dp))
         Spacer(modifier= Modifier.width(5.dp))

         Text(text =text,
             style= MaterialTheme.typography.labelMedium
                 .copy(color = Color(0xFF647488)
                 ))
...
fun Modifier.socia():Modifier = composed{
